...
const SignIn: React.FC = () => {
  ...
  useEffect(() => {
    const baseURL = "https://6740ca67d0b59228b7f15e18.mockapi.io/shop_admin";

    if (!formSubmitted) return; // Do nothing if the form isn't submitted yet
    ...
    fetch(baseURL)
      ...
      .then((users) => {
        const existingUser = users.find(
          (user: User) =>
            user.gmail === formData.gmail && user.password === formData.password
        );
        ...
        if (existingUser) {
          ...
          if (existingUser.user === "user") {
            ...
            Swal.fire({
              icon: "success",
              title: "Welcome to ARI SHOP",
              text: "Logged in successfully!",
            }).then(() => {
              Navigate("/shop");
            });
          } else {
            // Logic for admin or other roles
            Swal.fire({
              icon: "success",
              title: "Welcome Admin",
              text: "Logged in successfully!",
      ...
      .finally(() => {
        setFormSubmitted(false); // Reset formSubmitted state after processing
      });
  ...
  return (
    <main className=" pt-10 xl:p-12 2xl:p-30 flex flex-wrap justify-center items-center ">
      <div className=" bg-black  w-full flex flex-wrap *:w-full  mb-10 rounded-lg ">
        <h1 className=" flex justify-center items-center p-2  text-white text-[30px]">Admin-id: ari@gmail.com</h1>
        <h1 className=" flex justify-center items-center p-2  text-white text-[30px]">Admin-pass: 123</h1>
      </div>
      <div className=" border border-slate-500 bg-slate-900 shadow-default rounded-xl ">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" to="/SignUp">
                <img className=" w-[250px] " src="/LOGOARI.png" alt="Logo" />
              </Link>

              <p className="2xl:px-20 xl:px-10 text-white">
                Sign in and explor the products in our shop.
              </p>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium text-white   underline">
                ARI SHOP
              </span>
