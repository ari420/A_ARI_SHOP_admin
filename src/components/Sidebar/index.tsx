...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`fixed left-0 top-0 z-9999 flex h-[100vh] w-[300px] flex-col overflow-y-hidden bg-slate-900 duration-300 ease-linear dark:bg-boxdark xl:static xl:translate-x-0 ${
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/admin">
          <img className=" w-[80px]" src="/logo-icon.svg" alt="Logo" />
        </NavLink>
